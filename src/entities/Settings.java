...
public class Settings {
	...
	public String toString() {
		return "Settings [id=" + id + ", max_borrow_date=" + max_borrow_date + ", borrow_fee_per_loan="
				+ borrow_fee_per_loan + ", late_fee_per_day=" + late_fee_per_day + ", deposit_per_loan="
				+ deposit_per_loan + ", lost_compensation_fee=" + lost_compensation_fee + ", damaged_compensation_fee="
