...
public class LoanDetailsModel {
	...
	public void checkInBook(int detailId, int bookId, String statusUI, LocalDate returnDate, double lateFee, double compFee) {
        ...
        try {
            ...
            if (statusUI != null) {
                if (statusUI.equalsIgnoreCase("Lost")) statusEnum = "Lost";
                else if (statusUI.equalsIgnoreCase("Damaged")) statusEnum = "Damaged";
                else if (statusUI.equalsIgnoreCase("Repaired")) statusEnum = "Repaired";
            }
